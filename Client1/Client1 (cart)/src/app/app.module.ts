...
import { ClistallrestaurantComponent } from './clistallrestaurant/clistallrestaurant.component';
...
const parentModuleRoutes: Routes = [
  ...
  {
    path: 'home', component: HomeComponent, children: [{ path: 'pdfupload', component: PdfuploadComponent }]
  },
  ...
  {
    path: 'admin', component: AdminComponent, children: [{ path: 'changepassword', component: ChangepasswordComponent }]
  },
  ...
  {
    path: 'deliveryboy', component: DeliveryboyComponent, children: [{ path: 'changepassword', component: ChangepasswordComponent }]
  },
  {
  ...
  {
    path: 'customer', component: CustomerComponent, children: [{ path: 'cmenulist/:vid', component: CmenulistComponent }]
  },
  {
    path: 'customer', component: CustomerComponent, children: [{ path: 'paymentdetails', component: CpaymentdetailsComponent }]
  },
  {
    path: 'customer', component: CustomerComponent, children: [{ path: 'listallrestaurant', component: ClistallrestaurantComponent }]
  },
  {
    path: 'customer', component: CustomerComponent, children: [{ path: 'userprofile', component: UserprofileComponent }]
  },
  {
    path: 'customer', component: CustomerComponent, children: [{ path: 'changepassword', component: ChangepasswordComponent }]
  },
  {
    path: 'customer', component: CustomerComponent, children: [{ path: 'cfeedback', component: CfeedbackComponent }]
  },
  ...
  {
    path: 'vendor', component: VendorComponent, children: [{ path: 'pendingorders', component: VpendingordersComponent }]
  },

  {
    path: 'vendor', component: VendorComponent, children: [{ path: 'changepassword', component: ChangepasswordComponent }]
  },

  {
    path: 'vendor', component: VendorComponent, children: [{ path: 'userprofile', component: UserprofileComponent }]
  },
